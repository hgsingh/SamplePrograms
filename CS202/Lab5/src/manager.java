...
public class manager {
	...
	public void make_application() throws IOException
	{
		...
		binary_tree.insert_bst(new_application); //binary tree insertion done here
    ...
    /*
     * harsukh singh cs 202 assignment 4
     * edits the application using the key and score value 
     */
    public void edit_application()
    {
    	Scanner in = new Scanner(System.in);
    	System.out.println("If you would like to edit your application please press 'y'");
		char choice  = in.nextLine().charAt(0);
		choice = Character.toLowerCase(choice);
		if(choice == 'y')
		{
			int key;
			int score;
			System.out.println("Please enter the key set for the application");
			key = in.nextInt();
			System.out.println("Please enter the score you recieved in CS202 as an integer value from 0-100, If you did not take it press 0. ");
			score = in.nextInt();
			binary_tree.edit(key, score);
		}
		System.out.println("If you would like to remove an application please press 'y'");
		choice  = in.nextLine().charAt(0);
		choice = Character.toLowerCase(choice);
		if(choice == 'y')
		{
