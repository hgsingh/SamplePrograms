...
class required
{
	...
	int remove_class(gen_class* &a_class, char* course_name, float grade_check);//remove from list
        void display(gen_class * &a_class);//display a class in the list
    public:
	required();//constructor 
	~required(); //destructor
       	void make_list(); // make the list
        int remove_class(char* course_name, float grade_check);//remove class
